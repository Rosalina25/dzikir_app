...
import 'package:dzikir_app/nabi/nabi_content.dart';
                          ...
                          Stack(
                            children: <Widget>[
                              Padding(
                                ...
                                child: Hero(
                                    tag: 'firstDzikir',
                                    child: Image(image: AssetImage('assets/img/main_icon.png'),width: 20,
                                    )
                                ),
                              ),
                              Padding(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                      margin: EdgeInsets.only(top: 8.0),
                                      child: Text('25 Nabi yang Wajib Kita Teladani',
                                          style: tagLine))
                                ],
                              ),
                            ),
